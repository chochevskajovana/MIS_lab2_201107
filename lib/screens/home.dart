...
import 'package:lab2_201107/screens/shopping_cart.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("201107 Clothes shop"),
          ...
          actions: [
            ElevatedButton(
              ...
              style: const ButtonStyle(
                  backgroundColor:
                  MaterialStatePropertyAll<Color>(Color.fromRGBO(175,225,175,1.0))),
              child: const Text(
                "Add clothes",
                style: TextStyle(color: Color.fromRGBO(137,1,4,1.0)),
              ),
            )
          ],
        ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        style: const ButtonStyle(
                          backgroundColor: MaterialStatePropertyAll<Color>(Color.fromRGBO(175,225,175,1.0)),
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        child: const Row(
                          children: [
                            Icon(Icons.delete, color: Color.fromRGBO(137,1,4,1.0),),
                            Text("Delete", style: TextStyle(color: Color.fromRGBO(137,1,4,1.0))),
                            ],
                        )
                      ),
                      ElevatedButton(
                        ...
                        child: const Row(
                          children: [
                            Icon(Icons.edit, color: Color.fromRGBO(137,1,4,1.0),),
                            Text("Edit", style: TextStyle(color: Color.fromRGBO(137,1,4,1.0))),
                          ],
                        )
                      ),
                    ],
        ...
        floatingActionButton: Row(
          ...
          children: [
            ElevatedButton(
                ...
                child: const Row(
                  children: [
                    Icon(Icons.add_shopping_cart, color: Color.fromRGBO(137,1,4,1.0),),
                    Text("View cart", style: TextStyle(color: Color.fromRGBO(137,1,4,1.0)), )
                  ],
                ))
          ],
        ));
